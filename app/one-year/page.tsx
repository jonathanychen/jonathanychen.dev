  ...
  return (
    <main className={font.className}>
      ...
      {start && <><div className="flex justify-center h-screen w-screen">
        <h1 className="absolute self-center h-fit text-2xl lg:p-48 p-12">
          {introText}
        </h1>
        ...
        <div className="flex flex-col justify-center h-screen w-screen lg:p-48 p-12">
          <div className="flex flex-col self-center justify-center max-w-screen-lg">
...
const LETTER1 = `Now that graduation is right around the corner, it's hard to ignore the fact that we don't know where we'll be a few months from now. But no matter what happens next, I know we'll figure it out. 
